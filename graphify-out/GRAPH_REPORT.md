...
## Corpus Check
- 46 files · ~15,766 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 515 nodes · 814 edges · 27 communities (26 shown, 1 thin omitted)
...
1. `Config` - 20 edges
2. `CloudTextures` - 19 edges
3. `CloudTexture3D` - 17 edges
4. `SettingsGenerator` - 17 edges
5. `TranspilerHelpers` - 17 edges
6. `PreloaderHelpers` - 16 edges
7. `AnomalyBridge` - 15 edges
8. `ClientPlugin.Settings.Elements` - 15 edges
9. `Control` - 15 edges
10. `CloudTexture2D` - 14 edges
...
Cohesion: 0.08
Nodes (26): CloudTexture2D, Name, Resource, Size, Size3, Srv, CloudTexture3D, Name (+18 more)
...
Cohesion: 0.06
Nodes (25): Assembly, AnomalyBridge, HasDisplayTenant, IsRegistered, PackRoot, IEnumerable, ISrvBindable, MethodInfo (+17 more)

### Community 3 - "Plugin"
Cohesion: 0.08
Nodes (17): CloudSampler, Config, Vector3, Plugin, Instance, MethodImpl, AnomalyTerminalHook, Action (+9 more)
...
### Community 8 - "Config"
Cohesion: 0.09
Nodes (22): CloudQuality, High, Low, Medium, Ultra, Config, AlbedoTint, CirrusStrength (+14 more)
...
Cohesion: 0.09
Nodes (21): ColorAttribute, SupportedTypes, Action, Color, Func, List, Type, ControlButtonData (+13 more)
...
### Community 24 - "ClientPlugin.Settings.Elements"
Cohesion: 0.24
Nodes (5): ClientPlugin, ClientPlugin.Settings.Elements, ClientPlugin.Settings, ClientPlugin.RichHud, ClientPlugin.Settings.Layouts
...
- **Why does `System.Runtime.CompilerServices` connect `Attribute` to `ClientPlugin.Settings.Elements`, `TranspilerHelpers`, `Hashing`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `SettingsGenerator` connect `SettingsGenerator` to `ClientPlugin.Settings.Elements`, `Control`, `Plugin`, `Config`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `ClientPlugin.Settings.Elements` connect `ClientPlugin.Settings.Elements` to `KeybindAttribute`, `Slider`, `Dropdown`, `Control`, `Button`, `CheckboxAttribute`, `Element 2`, `Separator`, `Textbox`?**
